...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    com.sleepingpandaaa.MYBANK.HistoryList HistoryList;
    List<Model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(com.sleepingpandaaa.MYBANK.HistoryList historyList, List<Model> modelList) {
